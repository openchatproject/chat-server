...
import com.openchat.imservice.push.AuthorizationFailedException;
    ...
    implements SharedPreferences.OnSharedPreferenceChangeListener
{
  ...
  private void initializePushMessagingToggle() {
    ...
    preference.setChecked(OpenchatServicePreferences.isPushRegistered(this));
  ...
  private void handleIdentitySelection(Intent data) {
    ...
    if (contactUri != null) {
      OpenchatServicePreferences.setIdentityContactUri(this, contactUri.toString());
      initializeIdentitySelection();
    }
  }
      ...
      protected void onPostExecute(Integer result) {
        ...
        switch (result) {
          ...
          case SUCCESS:
            ...
            OpenchatServicePreferences.setPushRegistered(ApplicationPreferencesActivity.this, false);
            break;
        }
      }
  ...
  private class TrimNowClickListener implements Preference.OnPreferenceClickListener {
    @Override
    public boolean onPreferenceClick(Preference preference) {
      final int threadLengthLimit = OpenchatServicePreferences.getThreadTrimLength(ApplicationPreferencesActivity.this);
      AlertDialog.Builder builder = new AlertDialog.Builder(ApplicationPreferencesActivity.this);
      ...
      if (!((CheckBoxPreference)preference).isChecked()) {
        ...
        builder.setPositiveButton(R.string.ApplicationPreferencesActivity_disable, new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface dialog, int which) {
            ...
            OpenchatServicePreferences.setPasswordDisabled(ApplicationPreferencesActivity.this, true);
  ...
  private String buildOutgoingSmsDescription() {
    ...
    final boolean       dataFallback    = OpenchatServicePreferences.isFallbackSmsAllowed(this);
    final boolean       dataFallbackAsk = OpenchatServicePreferences.isFallbackSmsAskRequired(this);
    final boolean       nonData         = OpenchatServicePreferences.isDirectSmsAllowed(this);
