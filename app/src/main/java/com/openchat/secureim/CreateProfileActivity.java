...
import com.openchat.secureim.profiles.ProfileMediaConstraints;
import com.openchat.secureim.profiles.SystemProfileUtil;
...
import com.openchat.secureim.util.FileProviderUtil;
import com.openchat.secureim.util.IntentUtils;
...
public class CreateProfileActivity extends BaseActionBarActivity implements InjectableType {
  ...
  @Inject openchatServiceAccountManager accountManager;
  ...
  private void initializeResources() {
    ...
    informationLabel.setOnClickListener(view -> {
      ...
      intent.setData(Uri.parse("https://support.openchat.org/hc/en-us/articles/115001434171"));
  ...
  private Intent createAvatarSelectionIntent(@Nullable File captureFile, boolean includeClear, boolean includeCamera) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("com.openchat.securesms.action.CLEAR_PROFILE_PHOTO"));
    }
