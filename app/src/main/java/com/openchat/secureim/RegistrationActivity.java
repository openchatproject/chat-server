...
public class RegistrationActivity extends SherlockActivity {
  ...
  public void onCreate(Bundle icicle) {
    ...
    getSupportActionBar().setTitle(getString(R.string.RegistrationActivity_connect_with_openchatservice));
  ...
  private void initializeNumber() {
    ...
    String          localNumber = com.openchat.imservice.util.Util.getDeviceE164Number(this);
  ...
  private class CancelButtonListener implements View.OnClickListener {
    @Override
    public void onClick(View v) {
      OpenchatServicePreferences.setPromptedPushRegistration(RegistrationActivity.this, true);
