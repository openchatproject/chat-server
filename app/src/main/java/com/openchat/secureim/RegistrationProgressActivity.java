...
public class RegistrationProgressActivity extends BaseActionBarActivity {
  ...
  private void initializeLinks() {
    ...
    String          pretext         = getString(R.string.registration_progress_activity__openchatservice_timed_out_while_waiting_for_a_verification_sms_message);
  ...
  private class VerifyClickListener implements View.OnClickListener {
    ...
    public VerifyClickListener(String e164number, String password) {
      ...
      this.openchatingKey = Util.getSecret(52);
        ...
        protected void onPostExecute(Integer result) {
          ...
          switch (result) {
            case SUCCESS:
              ...
              intent.putExtra("openchating_key", openchatingKey);
              intent.putExtra("master_secret", masterSecret);
              startService(intent);
              break;
            case NETWORK_ERROR:
