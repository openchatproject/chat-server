package com.openchat.secureim.color;
...
public enum MaterialColor {
  ...
  GROUP      (GREY.conversationColorLight, R.color.openchatservice_primary, R.color.openchatservice_primary_dark,
              GREY.conversationColorDark, R.color.openchatservice_primary, R.color.openchatservice_primary_dark,
              "group_color");
