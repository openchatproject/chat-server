...
import com.openchat.secureim.TransportOption;
import com.openchat.secureim.components.emoji.EmojiEditText;
...
public class ComposeText extends EmojiEditText {
  ...
  public void setTransport(TransportOption transport) {
    final boolean enterSends     = OpenchatServicePreferences.isEnterSendsEnabled(getContext());
    final boolean useSystemEmoji = OpenchatServicePreferences.isSystemEmojiPreferred(getContext());
