...
public class CustomDefaultPreference extends DialogPreference {
  ...
  private boolean isCustom() {
    return OpenchatServicePreferences.getBooleanPreference(getContext(), customToggle, false);
  }

  private void setCustom(boolean custom) {
    OpenchatServicePreferences.setBooleanPreference(getContext(), customToggle, custom);
  }

  private String getCustomValue() {
    return OpenchatServicePreferences.getStringPreference(getContext(), customPreference, "");
  }

  private void setCustomValue(String value) {
    OpenchatServicePreferences.setStringPreference(getContext(), customPreference, value);
  }
