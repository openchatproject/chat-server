...
public class DefaultSmsReminder extends Reminder {
  ...
  public DefaultSmsReminder(final Context context) {
    ...
    final OnClickListener okListener = new OnClickListener() {
      ...
      public void onClick(View v) {
        OpenchatServicePreferences.setPromptedDefaultSmsProvider(context, true);
  ...
  public static boolean isEligible(Context context) {
    ...
    if (isDefault) {
      OpenchatServicePreferences.setPromptedDefaultSmsProvider(context, false);
    }

    return !isDefault && !OpenchatServicePreferences.hasPromptedDefaultSmsProvider(context);
  }
}
