...
public class openchatMapView extends LinearLayout {

  private MapView   mapView;
  private ImageView imageView;
  private TextView  textView;

  public openchatMapView(Context context) {
    this(context, null);
  }

  public openchatMapView(Context context, AttributeSet attrs) {
    super(context, attrs);
    initialize(context);
  }

  @TargetApi(Build.VERSION_CODES.HONEYCOMB)
  public openchatMapView(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  private void initialize(Context context) {
    ...
    LayoutInflater.from(context).inflate(R.layout.openchat_map_view, this, true);
  ...
  public ListenableFuture<Bitmap> display(final openchatPlace place) {
