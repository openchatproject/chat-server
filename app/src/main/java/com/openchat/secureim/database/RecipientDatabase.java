...
public class RecipientDatabase extends Database {
  ...
  private static final String openchat_PROFILE_NAME     = "openchat_profile_name";
  private static final String openchat_PROFILE_AVATAR   = "openchat_profile_avatar";
  ...
  private static final String[] RECIPIENT_PROJECTION = new String[] {
      ...
      openchat_PROFILE_NAME, openchat_PROFILE_AVATAR, PROFILE_SHARING
  };
  ...
  public static final String CREATE_TABLE =
      "CREATE TABLE " + TABLE_NAME +
          ...
          openchat_PROFILE_NAME + " TEXT DEFAULT NULL, " +
          openchat_PROFILE_AVATAR + " TEXT DEFAULT NULL, " +
  ...
  Optional<RecipientSettings> getRecipientSettings(@NonNull Cursor cursor) {
    ...
    String  openchatProfileName     = cursor.getString(cursor.getColumnIndexOrThrow(openchat_PROFILE_NAME));
    String  openchatProfileAvatar   = cursor.getString(cursor.getColumnIndexOrThrow(openchat_PROFILE_AVATAR));
    ...
    return Optional.of(new RecipientSettings(blocked, muteUntil,
                                             ...
                                             openchatProfileName, openchatProfileAvatar, profileSharing));
  }
  ...
  public void setProfileName(@NonNull Recipient recipient, @Nullable String profileName) {
    ContentValues contentValues = new ContentValues(1);
    contentValues.put(openchat_PROFILE_NAME, profileName);
  ...
  public void setProfileAvatar(@NonNull Recipient recipient, @Nullable String profileAvatar) {
    ContentValues contentValues = new ContentValues(1);
    contentValues.put(openchat_PROFILE_AVATAR, profileAvatar);
    updateOrInsert(recipient.getAddress(), contentValues);
  ...
  public static class RecipientSettings {
    ...
    private final String          openchatProfileName;
    private final String          openchatProfileAvatar;
    ...
    RecipientSettings(boolean blocked, long muteUntil,
                      ...
                      @Nullable String openchatProfileName,
                      @Nullable String openchatProfileAvatar,
                      boolean profileSharing)
    {
      ...
      this.openchatProfileName     = openchatProfileName;
      this.openchatProfileAvatar   = openchatProfileAvatar;
    ...
    public @Nullable String getProfileName() {
      return openchatProfileName;
    }

    public @Nullable String getProfileAvatar() {
      return openchatProfileAvatar;
    }
