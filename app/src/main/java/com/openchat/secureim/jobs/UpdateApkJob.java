...
import com.openchat.secureim.service.UpdateApkReadyListener;
import com.openchat.secureim.util.FileUtils;
...
public class UpdateApkJob extends ContextJob {
  ...
  private void handleDownloadStart(String uri, String versionName, byte[] digest) {
    ...
    downloadRequest.setTitle("Downloading openchat update");
    downloadRequest.setDescription("Downloading openchat " + versionName);
    downloadRequest.setVisibleInDownloadsUi(false);
    downloadRequest.setDestinationInExternalFilesDir(context, null, "openchat-update.apk");
