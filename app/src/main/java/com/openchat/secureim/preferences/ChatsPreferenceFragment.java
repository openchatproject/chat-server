...
public class ChatsPreferenceFragment extends PreferenceFragment {
  ...
  public void onCreate(Bundle paramBundle) {
    ...
    findPreference(OpenchatServicePreferences.MEDIA_DOWNLOAD_MOBILE_PREF)
        .setOnPreferenceChangeListener(new MediaDownloadChangeListener());
    findPreference(OpenchatServicePreferences.MEDIA_DOWNLOAD_WIFI_PREF)
        .setOnPreferenceChangeListener(new MediaDownloadChangeListener());
    findPreference(OpenchatServicePreferences.MEDIA_DOWNLOAD_ROAMING_PREF)
        .setOnPreferenceChangeListener(new MediaDownloadChangeListener());

    findPreference(OpenchatServicePreferences.THREAD_TRIM_NOW)
        .setOnPreferenceClickListener(new TrimNowClickListener());
    findPreference(OpenchatServicePreferences.THREAD_TRIM_LENGTH)
  ...
  private void setMediaDownloadSummaries() {
    findPreference(OpenchatServicePreferences.MEDIA_DOWNLOAD_MOBILE_PREF)
        .setSummary(getSummaryForMediaPreference(OpenchatServicePreferences.getMobileMediaDownloadAllowed(getActivity())));
    findPreference(OpenchatServicePreferences.MEDIA_DOWNLOAD_WIFI_PREF)
        .setSummary(getSummaryForMediaPreference(OpenchatServicePreferences.getWifiMediaDownloadAllowed(getActivity())));
    findPreference(OpenchatServicePreferences.MEDIA_DOWNLOAD_ROAMING_PREF)
        .setSummary(getSummaryForMediaPreference(OpenchatServicePreferences.getRoamingMediaDownloadAllowed(getActivity())));
  }
