...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://com.openchat.secureim.provider.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("com.openchat.secureim.provider.mms", "mms/#", SINGLE_ROW);
  }
