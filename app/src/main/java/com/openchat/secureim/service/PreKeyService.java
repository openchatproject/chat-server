...
public class PreKeyService extends Service {
  ...
  public  static final String CLEAN_ACTION         = "com.openchat.secureim.PreKeyService.CLEAN";
  public  static final String CREATE_SIGNED_ACTION = "com.openchat.secureim.PreKeyService.CREATE_SIGNED";
  ...
  static class CleanSignedPreKeysTask implements Runnable {
    ...
    public CleanSignedPreKeysTask(Context context, MasterSecret masterSecret) {
      this(new OpenchatServicePreKeyStore(context, masterSecret), PushServiceSocketFactory.create(context));
    }
