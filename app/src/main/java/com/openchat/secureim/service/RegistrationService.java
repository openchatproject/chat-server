...
public class RegistrationService extends Service {
  ...
  private void handleCommonRegistration(OpenchatServiceAccountManager accountManager, String number)
      throws IOException
  {
    ...
    OpenchatServicePreferences.setWebsocketRegistered(this, true);
  ...
  private void markAsVerified(String number, String password, String openchatingKey) {
    ...
    OpenchatServicePreferences.setPromptedPushRegistration(this, true);
  }
