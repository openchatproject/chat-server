...
import com.openchat.secureim.sms.IncomingJoinedMessage;
...
public class DirectoryHelper {
  ...
  private static @NonNull List<Address> refreshDirectory(@NonNull Context context, @NonNull openchatServiceAccountManager accountManager)
      throws IOException
  {
  ...
  private static Optional<AccountHolder> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("com.openchat.securesms");
  ...
  private static Optional<AccountHolder> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "com.openchat.securesms");
