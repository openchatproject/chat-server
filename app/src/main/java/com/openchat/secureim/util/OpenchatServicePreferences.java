...
public class OpenchatServicePreferences {
  ...
  private static final String TAG = OpenchatServicePreferences.class.getSimpleName();
  ...
  private static final String OPENCHATING_KEY_PREF               = "pref_openchating_key";
  ...
  public static void setOpenchatingKey(Context context, String openchatingKey) {
    setStringPreference(context, OPENCHATING_KEY_PREF, openchatingKey);
  }

  public static String getOpenchatingKey(Context context) {
    return getStringPreference(context, OPENCHATING_KEY_PREF, null);
  }
  ...
  public static boolean getUseCustomMmsc(Context context) {
    boolean legacy = OpenchatServicePreferences.isLegacyUseLocalApnsEnabled(context);
  ...
  public static void setPushRegistered(Context context, boolean registered) {
    Log.w("OpenchatServicePreferences", "Setting push registered: " + registered);
