package com.openchat.secureim.webrtc;
...
public class CallNotificationBuilder {
  ...
  public static Notification getCallInProgressNotification(Context context, int type, Recipient recipient) {
    ...
    if (type == TYPE_INCOMING_CONNECTING) {
      ...
      builder.setContentText(context.getString(R.string.NotificationBarManager__incoming_openchat_call));
      ...
      builder.setContentText(context.getString(R.string.NotificationBarManager__establishing_openchat_call));
      ...
      builder.setContentText(context.getString(R.string.NotificationBarManager_openchat_call_in_progress));
