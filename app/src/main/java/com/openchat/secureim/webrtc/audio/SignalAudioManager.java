package com.openchat.secureim.webrtc.audio;
...
public class openchatAudioManager {

  private static final String TAG = openchatAudioManager.class.getSimpleName();
  ...
  public openchatAudioManager(@NonNull Context context) {
