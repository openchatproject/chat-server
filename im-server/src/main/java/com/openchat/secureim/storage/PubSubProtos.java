...
public final class PubSubProtos {
  ...
  public static final class PubSubMessage extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              com.openchat.secureim.storage.PubSubProtos.PubSubMessage.Type value = com.openchat.secureim.storage.PubSubProtos.PubSubMessage.Type.valueOf(rawValue);
              if (value == null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.openchat.secureim.storage.PubSubProtos.internal_static_textsecure_PubSubMessage_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.openchat.secureim.storage.PubSubProtos.internal_static_textsecure_PubSubMessage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              com.openchat.secureim.storage.PubSubProtos.PubSubMessage.class, com.openchat.secureim.storage.PubSubProtos.PubSubMessage.Builder.class);
    }
    ...
    public enum Type
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return com.openchat.secureim.storage.PubSubProtos.PubSubMessage.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public static com.openchat.secureim.storage.PubSubProtos.PubSubMessage parseFrom(
    ...
    public static com.openchat.secureim.storage.PubSubProtos.PubSubMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static com.openchat.secureim.storage.PubSubProtos.PubSubMessage parseFrom(
    ...
    public static com.openchat.secureim.storage.PubSubProtos.PubSubMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.openchat.secureim.storage.PubSubProtos.PubSubMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static com.openchat.secureim.storage.PubSubProtos.PubSubMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(com.openchat.secureim.storage.PubSubProtos.PubSubMessage prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using com.openchat.secureim.storage.PubSubProtos.PubSubMessage.newBuilder()
      private Builder() {
      ...
      public com.openchat.secureim.storage.PubSubProtos.PubSubMessage getDefaultInstanceForType() {
        return com.openchat.secureim.storage.PubSubProtos.PubSubMessage.getDefaultInstance();
      }

      public com.openchat.secureim.storage.PubSubProtos.PubSubMessage build() {
        com.openchat.secureim.storage.PubSubProtos.PubSubMessage result = buildPartial();
      ...
      public com.openchat.secureim.storage.PubSubProtos.PubSubMessage buildPartial() {
        com.openchat.secureim.storage.PubSubProtos.PubSubMessage result = new com.openchat.secureim.storage.PubSubProtos.PubSubMessage(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.openchat.secureim.storage.PubSubProtos.PubSubMessage) {
          return mergeFrom((com.openchat.secureim.storage.PubSubProtos.PubSubMessage)other);
        } else {
      ...
      public Builder mergeFrom(com.openchat.secureim.storage.PubSubProtos.PubSubMessage other) {
        if (other == com.openchat.secureim.storage.PubSubProtos.PubSubMessage.getDefaultInstance()) return this;
        if (other.hasType()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.openchat.secureim.storage.PubSubProtos.PubSubMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (com.openchat.secureim.storage.PubSubProtos.PubSubMessage) e.getUnfinishedMessage();
          throw e;
        } finally {
