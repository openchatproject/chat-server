...
public class DeviceGroupsOutputStream extends ChunkedOutputStream {
  ...
  private void writeGroupDetails(DeviceGroup group) throws IOException {
    OpenchatServiceProtos.GroupDetails.Builder groupDetails = OpenchatServiceProtos.GroupDetails.newBuilder();
    ...
    if (group.getAvatar().isPresent()) {
      OpenchatServiceProtos.GroupDetails.Avatar.Builder avatarBuilder = OpenchatServiceProtos.GroupDetails.Avatar.newBuilder();
