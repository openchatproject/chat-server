...
public class PushServiceSocket {
  ...
  public void verifyAccountCode(String verificationCode, String openchatingKey, int registrationId, boolean fetchesMessages, String pin)
      throws IOException
  {
    AccountAttributes openchatingKeyEntity = new AccountAttributes(openchatingKey, registrationId, fetchesMessages, pin);
    makeServiceRequest(String.format(VERIFY_ACCOUNT_CODE_PATH, verificationCode),
                       "PUT", JsonUtil.toJson(openchatingKeyEntity));
  }

  public void setAccountAttributes(String openchatingKey, int registrationId, boolean fetchesMessages, String pin) throws IOException {
    AccountAttributes accountAttributes = new AccountAttributes(openchatingKey, registrationId, fetchesMessages, pin);
